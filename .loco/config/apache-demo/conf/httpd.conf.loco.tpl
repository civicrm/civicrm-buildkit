...
<VirtualHost *:{{HTTPD_PORT}}>
    ...
    # [demo.yml:dfl]  If $HOME/bknix/build-dfl/build/$VHOST/web  ===> set BKIT_PHPFPM=9009 and BKIT_DOCROOT=...
    # [demo.yml:min]  If $HOME/bknix/build-min/$VHOST/web  ===> set BKIT_PHPFPM=9010 and BKIT_DOCROOT=...
    # [demo.yml:max]  If $HOME/bknix/build-max/$VHOST/web  ===> set BKIT_PHPFPM=9011 and BKIT_DOCROOT=...
    # [demo.yml:edge] If $HOME/bknix/build-edge/$VHOST/web ===> set BKIT_PHPFPM=9015 and BKIT_DOCROOT=...
