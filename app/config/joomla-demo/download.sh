...
pushd "$WEB_ROOT" >> /dev/null
  git_cache_clone_id civicrm/civicrm-joomla            -b "$CIVI_VERSION" src/civicrm
  git_cache_clone_id civicrm/civicrm-core              -b "$CIVI_VERSION" src/civicrm/admin/civicrm
  git_cache_clone_id civicrm/civicrm-packages          -b "$CIVI_VERSION" src/civicrm/admin/civicrm/packages
