 ...
 */
$bodyValue = '<p><strong><a href="https://civicrm.org" target="_blank" title="Opens CiviCRM.org site in a new window.">CiviCRM</a> is a community-based open source project to build constituent relationship management functionality for the nonprofit, advocacy and nongovernmental sectors.
...
<a href="/user/login/?destination=civicrm/dashboard">Login</a> with...
<strong>Username:</strong> demo<br />
<strong>Password:</strong> demo</p>
... and click the <a href="/civicrm"><strong>CiviCRM</strong></a> link located at the top of the screen (if you are not automatically redirected).
...
<ul>
<li>Learn about how you can use CiviCRM from our new <strong><a href="https://docs.civicrm.org/user/en/latest/" target="_blank" title="Opens Understanding CiviCRM book in a new window">online book</a></strong>.</li>
