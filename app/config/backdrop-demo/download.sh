...
pushd "$WEB_ROOT/web/modules" >> /dev/null
  ...
  git_cache_clone_id civicrm/civicrm-backdrop      -b "1.x-$CIVI_VERSION" civicrm/backdrop
  git_cache_clone_id civicrm/civicrm-packages      -b "$CIVI_VERSION"     civicrm/packages
  git_cache_clone_id civicrm/org.civicoop.civirules              -b "$RULES_VERSION"     civicrm/tools/extensions/org.civicoop.civirules
  git_cache_clone_id TechToThePeople/civisualize                 -b "master"             civicrm/tools/extensions/civisualize
  git_cache_clone_id civicrm/org.civicrm.module.cividiscount     -b "$DISC_VERSION"      civicrm/tools/extensions/cividiscount
  git_cache_clone_id civicrm/org.civicrm.contactlayout           -b "master"             civicrm/tools/extensions/org.civicrm.contactlayout
