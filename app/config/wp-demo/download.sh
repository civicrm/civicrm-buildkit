...
pushd $WEB_ROOT/wp-content/plugins >> /dev/null
  ...
  git_cache_clone ${CACHE_DIR}/civicrm/civicrm-wordpress.git -b "$CIVI_VERSION" civicrm
  git_cache_clone ${CACHE_DIR}/civicrm/civicrm-core.git      -b "$CIVI_VERSION" civicrm/civicrm
  git_cache_clone ${CACHE_DIR}/civicrm/civicrm-packages.git  -b "$CIVI_VERSION" civicrm/civicrm/packages
